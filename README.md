...
L’essentiel affiche le CA, les commandes, la marge avant publicité, le résultat cumulé partiel estimé, les dépenses Meta observées et le solde professionnel daté. Le résultat est calculé par composantes (marge moins publicité, charges fixes, autres charges et commission confirmée) pour conserver les coûts des journées où l’historique Meta manque. Une panne du connecteur ou une composante inconnue bloque le calcul ; une période Meta partielle reste explicitement qualifiée. Les soldes personnels et de démonstration sont exclus ; des comptes de dates ou devises différentes ne sont pas additionnés.

Un seul graphique couvre toutes les années. Les euros et le nombre de commandes ont deux axes explicitement distincts. Le tableau sous le graphique fournit les valeurs et les variations annuelles ; l’année en cours est comparée aux mêmes dates de l’année précédente, jamais à son total annuel complet. La marge est calculée avant publicité et charges fixes, pas assimilée au bénéfice net. Les montants du repère 2027 sont affichés arrondis à 100 euros pour éviter une précision trompeuse ; les données et le détail du calcul conservent leur précision.
